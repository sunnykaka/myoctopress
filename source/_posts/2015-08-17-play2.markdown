...
description: "对Java使用者介绍PlayFramework，Play的用法，学习Play的教程"
---

### 1. 介绍
这篇文章会使用Play，Spring，JPA（hibernate）开发一个简单的CRUD功能，主要是为了介绍如何使用Play进行开发，如果对Play已经很熟悉了的朋友可以略过。
...
这篇文章我没有介绍如何启动应用，因为这需要一些开发环境的准备，以及了解SBT的基本用法。这些内容我会在下一篇博客介绍。这篇文章相关的代码已经提交到Github，[项目地址](TODO)。
